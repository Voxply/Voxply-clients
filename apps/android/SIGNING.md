...
| Secret name | Value |
|---|---|
| `ANDROID_KEYSTORE_BASE64` | `base64 -w0 wavvon.keystore` |
...
```
set TAURI_ANDROID_KEYSTORE_PATH=C:\path\to\wavvon.keystore
set TAURI_ANDROID_KEYSTORE_PASSWORD=yourpassword
set TAURI_ANDROID_KEY_ALIAS=wavvon
