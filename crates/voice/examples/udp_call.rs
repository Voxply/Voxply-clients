...
///   Terminal 1: cargo run --example udp_call -p wavvon-voice -- 4000 4001
///   Terminal 2: cargo run --example udp_call -p wavvon-voice -- 4001 4000
///
...
async fn main() -> Result<()> {
    ...
    if args.len() != 3 {
        ...
        println!("  Terminal 1: cargo run --example udp_call -p wavvon-voice -- 4000 4001");
        println!("  Terminal 2: cargo run --example udp_call -p wavvon-voice -- 4001 4000");
        return Ok(());
    }
